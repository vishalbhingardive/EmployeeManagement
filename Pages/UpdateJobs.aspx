<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateJobs.aspx.cs" Inherits="EmployeeManagement.Pages.UpdateJobs" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container bg-secondary">
            <h1 style="background-color:sandybrown" class=" text-bg-dark text-center">Update Job</h1>
