<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddEmployees.aspx.cs" Inherits="EmployeeManagement.Pages.AddEmployees" %>
              ...
              <div class=" row form-block mx-auto ">
                <div class="col-lg-6">
                   ...
                   <div class="col-lg-6">
                    ...
                    <div class="row">
                       <asp:RadioButton runat="server" class="col-lg-6 " ID="radioButtonMale" GroupName="Gender" Text="Male" />
                       <asp:RadioButton runat="server" class="col-lg-6 " ID="radioButtonFemale" GroupName="Gender" Text="Female" />
                ...
                <div class="col-lg-6">
                    <div></div>
                    <div class="mt-5">
                        <asp:Button runat="server" ID="ButtonCreate" Text="Create" OnClick="ButtonCreate_Click1"/>
