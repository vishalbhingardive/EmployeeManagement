<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Jobs.aspx.cs" Inherits="EmployeeManagement.Pages.Jobs" %>
         ...
         <div class="container">
            <div class="row mt-5 gy-3 ms-5">
                ...
                <div class="card-body ">
                    ...
                    <h6><%= job.Title %></h6>
                    <hr />
                    <h6><%= job.NumberofPositions %></h6>
                    <hr />
                    <h6><%= job.Location %></h6>
                    <hr />
                    <h6><%= job.SalaryRange %></h6>
                    <hr />
                  
                </div>
                    <div class="row card-footer">
                    
                    <h6 class="col" ><a href="UpdateJobs.aspx?id=<%= job.JobId %>">Edit</a></h6>
                    <h6 class="col"><a href="DeleteJob.aspx?id=<%= job.JobId %>">Delete</a></h6>
