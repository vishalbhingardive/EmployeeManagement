<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteEmployee.aspx.cs" Inherits="EmployeeManagement.Pages.DeleteEmployee" %>
            ...
            <div class=" row form-block mx-auto ">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mt-5">
                        ...
                        <a style="float: right" href="Employee.aspx">
